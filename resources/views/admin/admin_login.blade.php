          ...
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="*********" name="password" value="{{ old('password') }}">
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                      </span>
                ...
                <div class="form-group">
                  <button class="btn btn-block g-login">
                    <img class="mr-3" src="{{ asset('backend/images/file-icons/icon-google.svg') }}" alt="">Log in with Google</button>
                </div>
            ...
            <p class="footer-text text-center">copyright © 2018 SigmaSoftBD. All rights reserved.</p>
          </div>
        </div>
      </div>

            ...
            {{ csrf_field() }}
              <fieldset>
                <div class="control-group">
                  ...
                  <div class="controls">
                  <input type="text" class="span6 typeahead" id="typeahead" name="title" value="{{$brand->title}}">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img class="" src="{{ asset('image/brand/'.$brand->image) }}" alt="{{ $brand->title }}" height="70px" width="80px">
                      </div>
                    </div>

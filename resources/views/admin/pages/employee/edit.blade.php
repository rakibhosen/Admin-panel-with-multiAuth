            ...
            {{ csrf_field() }}
              <fieldset>
                <div class="control-group">
                  ...
                  <div class="controls">
                  <input type="text" class="span6 typeahead" id="typeahead" name="name" value="{{$employee->name}}">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                  <input type="number" class="span6 typeahead" id="typeahead" name="sell" value="{{$employee->sell}}">
